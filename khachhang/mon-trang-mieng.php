...
<meta name="title" content="Món Tráng Miệng"/>
...
<style>
    ...
    <body data-container="body"
        ...
        class="pl-thm-jollibee pl-thm-jollibee-default page-products categorypath-mon-trang-mieng category-mon-trang-mieng catalog-category-view page-layout-1column">
    ...
    <span>
        ...
        <div class="actions options switcher-options">
            ...
            <div class="switcher-list">
                            ...
                            <a href="https://jollibee.com.vn/stores/store/redirect/___store/en/___from_store/default/uenc/aHR0cHM6Ly9qb2xsaWJlZS5jb20udm4vbW9uLXRyYW5nLW1pZW5nLmh0bWw_X19fc3RvcmU9ZW4%2C/">
                                EN                            </a>
                        </div>
                                                                                    </div>
        </div>
...
<ul class="header links">
    ...
    <?php else: ?>
        ...
        <li class="authorization-link" data-label="or">
            <a href="login.php?redirect=mon-trang-mieng.php">Đăng nhập</a>
        </li>
    <?php endif; ?>
...
<ul id="menu" class="nav-menu ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" tabindex="0" aria-activedescendant="ui-id-10">
    ...
    <li class="level0 level-top parent active ui-menu-item" data-item-nav="item-menu" role="presentation">
        ...
        <ul class="menu-list ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" aria-expanded="false" style="display: none;" aria-hidden="true">
            ...
            <li class="level0 nav-7 category-item active level-top ui-menu-item" role="presentation"><a href="mon-trang-mieng.php" class="level-top ui-corner-all" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/trangmieng.png" class="thumbnail" width="100px"><span>Món Tráng Miệng</span></a></li>
...
<li><a href="https://jollibee.com.vn/customer/account/create/" id="id2qBHBxSP" >Đăng ký</a></li></ul><div class="download-app">
...
<script src="https://jollibee.com.vn/media/location/province_20260408135730.js"></script>
<script src="https://jollibee.com.vn/media/location/district_20260408135730.js"></script>
...
</div><div class="columns"><div class="column main"><input name="form_key" type="hidden" value="ACbUvcy5EZ13zXKW" /><div id="authenticationPopup" data-bind="scope:'authenticationPopup', style: {display: 'none'}">
...
<script type="text/x-magento-init">
    {
        "body": {
            "pageCache": {"url":"https:\/\/jollibee.com.vn\/page_cache\/block\/render\/id\/9\/","handles":["default","catalog_category_view","catalog_category_view_type_default","catalog_category_view_type_default_without_children","catalog_category_view_displaymode_products","catalog_category_view_id_9","pl_thm_jollibee_default","pl_thm_jollibee_default_default"],"originalRequest":{"route":"catalog","controller":"category","action":"view","uri":"\/mon-trang-mieng.html"},"versionCookieName":"private_content_version"}        }
    }
</script>
    ...
    require(['jquery'], function($) {
        ...
        <div class="block-content" aria-labelledby="block-customer-login-heading">
            <form class="form-customer-login" id="social-form-login" data-mage-init='{"validation":{}}'>
                <input name="form_key" type="hidden" value="ACbUvcy5EZ13zXKW" />                <div class="form-outler form-outler-top">
...
<script>
    ...
    <div id="full-address-popup">
        <form action="" class="form" data-mage-init='{"validation": {}}'>
            ...
            <div class="field input field-region">
                ...
                <div class="toolbar toolbar-products" data-mage-init='{"productListToolbarForm":{"mode":"product_list_mode","direction":"product_list_dir","order":"product_list_order","limit":"product_list_limit","modeDefault":"grid","directionDefault":"asc","orderDefault":"position","limitDefault":24,"url":"https:\/\/jollibee.com.vn\/mon-trang-mieng.html","formKey":"ACbUvcy5EZ13zXKW","post":false}}'>
                        <div class="modes">
 ...
 <div class="mn-delivery-wrap" data-role="delivery-switcher">
    ...
    <form class="mn-form" id="mn-form-main" data-bind="submit: submitMainForm">
        ...
        <?php
        // Lấy các món thuộc danh mục 'TrangMieng' và đang được bán (TrangThai = 1)
$sql = "SELECT * FROM monan WHERE MaLoai = 'TrangMieng' AND TrangThai = 1 ORDER BY MaMon DESC";
...
<script>
            ...
            'url': "https://jollibee.com.vn/mon-trang-mieng.html",
            'img_url': "/media/catalog/category/Mo_n_tra_ng_mie_ng.jpg"
        });
    </script>
    ...
    <script type="text/x-magento-init">
        {
            "*": {
                "Amasty_FacebookPixel/js/amfb-init": {
                    ...
                    "eventsData" : "\u007B\u0022content_name\u0022\u003A\u0022M\u005Cu00f3n\u0020Tr\u005Cu00e1ng\u0020Mi\u005Cu1ec7ng\u0022,\u0022content_ids\u0022\u003A\u005B\u00229\u0022\u005D,\u0022content_type\u0022\u003A\u0022product_group\u0022,\u0022value\u0022\u003A0,\u0022currency\u0022\u003A\u0022VND\u0022\u007D",
                    "isLogEnabled": "1",
                ...
                (function (events) {
                    function loadCode() {
                        ...
                        function run(response) {
                            var userData = {};
                            var apptrianTikTokPixelApiUrl="https://jollibee.com.vn/mon-trang-mieng.html";                            var apptrianTikTokPixelApiCategoryId=9;                                                        
                            ...
                            if (propagationStop === 0) {
                                ...
                                var categoryEventData = {"content_category":"M\u00f3n Tr\u00e1ng Mi\u1ec7ng"};
...
<script>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"NRJS-495c32bbd15c5696a46","applicationID":"1396432117","transactionName":"MQQDNUEECBEAAEQIWwhOIAJHDAkMThNRBlE5AgACWwA=","queueTime":0,"applicationTime":663,"atts":"HUMAQwkeGx8=","errorBeacon":"bam.nr-data.net","agent":""}</script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"e1824f48925549988f18394ee6dbcc2d","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
