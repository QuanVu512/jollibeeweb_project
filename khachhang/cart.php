...
<link rel="stylesheet" type="text/css" media="all" href="https://jollibee.com.vn/static/version1775488343/frontend/Jollibee/default/vi_VN/Amasty_Base/vendor/slick/amslick.min.css">
...
<script type="text/javascript" src="https://jollibee.com.vn/static/version1775488343/frontend/Jollibee/default/vi_VN/Amasty_Promo/js/amastyNoticeDisable.js"></script>
    ...
    <span>
        ...
        <div class="actions options switcher-options">
            ...
            <div class="switcher-list">
                            ...
                            <a href="https://jollibee.com.vn/stores/store/redirect/___store/en/___from_store/default/uenc/aHR0cHM6Ly9qb2xsaWJlZS5jb20udm4vY2hlY2tvdXQvY2FydC8_X19fc3RvcmU9ZW4%2C/">
                                EN                            </a>
                        </div>
                                                                                    </div>
        </div>
...
<li><a href="https://jollibee.com.vn/customer/account/create/" id="id0axTlOa6">Đăng ký</a></li><li class="authorization-link" data-label="or">
...
<ul id="menu" class="nav-menu ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" tabindex="0" aria-activedescendant="ui-id-2">
...
<li class="level0 level-top ui-menu-item item-promotion"><a href="/khuyen-mai" class="">Khuyến mãi</a></li>
...
<li class="level0 level-top ui-menu-item career"><a href="https://jollibee.talent.vn/" class="">Tuyển dụng</a></li>
</ul><ul class="header links"><li class="authorization-link" data-label="or">
    <a href="#social-login-popup" class="social-login-btn" data-effect="mfp-move-from-top">
        Đăng nhập    </a>
</li>
<li><a href="https://jollibee.com.vn/customer/account/create/" id="idQ3l91b2h">Đăng ký</a></li></ul><div class="download-app">
...
<script src="https://jollibee.com.vn/media/location/province_20260408112850.js"></script>
<script src="https://jollibee.com.vn/media/location/district_20260408112850.js"></script>
...
<!-- /ko -->
    ...
    <div class="block col-mp mp-12">
        <div class="block-content">
            <form class="form-fake-email" id="social-form-fake-email" novalidate="novalidate" data-gtm-form-interact-id="1">
                <fieldset class="fieldset" data-hasrequired="* Phần bắt buộc">
                    ...
                    <div class="field field-email-social required">
                        ...
                        <div class="control">
                            <input type="email" name="realEmail" alt="email" id="request-email" class="input-text" data-validate="{required:true, 'validate-email':true}" aria-required="true" data-gtm-form-interact-field-id="2">
                        </div>
                    </div>
                    <div class="field field-password-social required">
                        <label for="request-password-social" class="label"><span>Mật khẩu</span></label>
                        <div class="control">
                            <input type="password" name="password" id="request-password-social" title="Mật khẩu" class="input-text" data-validate="{required:true, 'validate-password':true}" autocomplete="off" aria-required="true" data-gtm-form-interact-field-id="3">
                        </div>
                    </div>
...
<script>
    require(['jquery'], function($) {
        ...
        <div class="block-content" aria-labelledby="block-customer-login-heading">
            <form class="form-customer-login" id="social-form-login" novalidate="novalidate" data-gtm-form-interact-id="2">
                <input name="form_key" type="hidden" value="ImwYKAOSVVPg94iw">                <div class="form-outler form-outler-top">
                    <fieldset class="fieldset login mp-8" data-hasrequired="* Phần bắt buộc">
                            ...
                            <div class="control">
                                                                    <input name="username" id="social_login_email" type="text" class="input-text" value="" autocomplete="off" title="Số điện thoại" data-validate="{required:true}" placeholder="Email / Số điện thoại" aria-required="true" data-gtm-form-interact-field-id="4">
                                                            </div>
                        </div>
                        <div class="field password required">
                            <div class="control">
                                <input name="password" id="social_login_pass" type="password" class="input-text" autocomplete="off" title="Mật khẩu" data-validate="{required:true, 'validate-password':true}" placeholder="Mật khẩu" aria-required="true" data-gtm-form-interact-field-id="5">
                            </div>
                        </div>
...
<div class="cart-empty">
    ...
    <p>Click <a href="mon-ngon-phai-thu.php">here</a> to continue shopping.    </p>
    </div>
...
<script>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"NRJS-495c32bbd15c5696a46","applicationID":"1396432117","transactionName":"MQQDNUEECBEAAEQIWwhOIAJHDAkMTgBYBFcNDhQVHAYHEBVMWQ9QAxk=","queueTime":0,"applicationTime":1081,"atts":"HUMAQwkeGx8=","errorBeacon":"bam.nr-data.net","agent":""}</script><script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon="{&quot;version&quot;:&quot;2024.11.0&quot;,&quot;token&quot;:&quot;e1824f48925549988f18394ee6dbcc2d&quot;,&quot;server_timing&quot;:{&quot;name&quot;:{&quot;cfCacheStatus&quot;:true,&quot;cfEdge&quot;:true,&quot;cfExtPri&quot;:true,&quot;cfL4&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfSpeedBrain&quot;:true},&quot;location_startswith&quot;:null}}" crossorigin="anonymous"></script>
...
<aside role="dialog" class="modal-custom pr-cookie-modal pr-cookie-modal-bottom
               " aria-describedby="modal-content-19" data-role="modal" data-type="custom" tabindex="0">
    <div data-role="focusable-start" tabindex="0"></div>
    <div class="modal-inner-wrap" data-role="focusable-scope" style="background-color: rgba(0, 34, 68, 0.89);">
        <div id="modal-content-19" class="modal-content" data-role="content"><div id="pr-cookie-notice" data-bind="afterRender: autoOpen()">
...
<aside role="dialog" class="modal-popup pr-cookie-details-modal
               ...
               " aria-describedby="modal-content-20" data-role="modal" data-type="popup" tabindex="0">
<div data-role="focusable-start" tabindex="0"></div>
<div class="modal-inner-wrap" data-role="focusable-scope">
    <div id="modal-content-20" class="modal-content" data-role="content"><div id="pr-cookie-setting-bar" data-bind="afterRender: createModal()">
...
<aside role="dialog" class="modal-popup popup-authentication
               modal-slide
               _inner-scroll" aria-describedby="modal-content-21" data-role="modal" data-type="popup" tabindex="0">
    <div data-role="focusable-start" tabindex="0"></div>
    <div class="modal-inner-wrap" data-role="focusable-scope">
        ...
        <div id="modal-content-21" class="modal-content" data-role="content"><div class="block-authentication" data-bind="afterRender: setModalElement, blockLoader: isLoading" style="">
...
<!-- ko if: isActive() --><!-- /ko --><!-- /ko -->
        <!-- /ko -->
        <div class="block-content" aria-labelledby="block-customer-login-heading">
            <form class="form form-login" method="post" data-bind="event: {submit: login }" id="login-form" data-gtm-form-interact-id="3">
                <div class="fieldset login" data-bind="attr: {'data-hasrequired': $t('* Required Fields')}" data-hasrequired="* Phần bắt buộc">
                    <div class="field email required">
                        ...
                        <div class="control">
                            <input name="username" id="customer-email" type="email" class="input-text" data-mage-init="{&quot;mage/trim-input&quot;:{}}" data-bind="attr: {autocomplete: autocomplete}" data-validate="{required:true, 'validate-email':true}" autocomplete="off" data-gtm-form-interact-field-id="6">
                        </div>
                    </div>
                    <div class="field password required">
                        <label for="pass" class="label"><span data-bind="i18n: 'Password'">Mật khẩu</span></label>
                        <div class="control">
                            <input name="password" type="password" class="input-text" id="pass" data-bind="attr: {autocomplete: autocomplete}" data-validate="{required:true}" autocomplete="off" data-gtm-form-interact-field-id="7">
                        </div>
                    </div>
