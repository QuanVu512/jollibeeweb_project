...
<meta name="title" content="Gà giòn vui vẻ">
<meta name="robots" content="INDEX,FOLLOW">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<meta name="format-detection" content="telephone=no">
<title>Gà giòn vui vẻ</title>
...
<ul id="menu" class="nav-menu ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" tabindex="0" aria-activedescendant="ui-id-10">
    ...
    <li class="level0 level-top parent active ui-menu-item" data-item-nav="item-menu" role="presentation">
        ...
        <ul class="menu-list ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" aria-expanded="false" style="display: none; top: 118px; left: 1214.41px;" aria-hidden="true">
            ...
            <li class="level0 nav-2 category-item active level-top ui-menu-item" role="presentation">
...
<script>
    ...
    <ol class="products list items product-items" data-mage-init='{"Magento_Catalog/js/product/list/anchor-scroll-item":{}}'>
        ...
        <?php
        // Lấy các món thuộc danh mục 'GaGion' và đang được bán (TrangThai = 1)
        $sql = "SELECT * FROM monan WHERE MaLoai = 'GaGion' AND TrangThai = 1 ORDER BY MaMon DESC";
        $result = mysqli_query($conn, $sql);

        // THÊM ĐIỀU KIỆN $result ĐỂ CHỐNG SẬP WEB
            ...
            <div class="product-item-info" data-id="<?php echo $maMon; ?>" style="cursor: pointer;">
                ...
                <span class="product-image-container" style="width: 268px;">
                    <span class="product-image-wrapper" style="padding-bottom: 100%;">
                        <img class="product-image-photo" src="<?php echo $urlHinhAnh; ?>" alt="<?php echo $tenMon; ?>" onerror="this.src='https://jollibee.com.vn/media/favicon/default/favicon.png'"/>
                    </span>
                </span>
        ...
        <?php 
            ...
            // In ra lỗi màu đỏ nếu DB có vấn đề thay vì làm trắng trang
            if (!$result) {
                echo "<p style='padding: 20px; color: red; font-size: 18px;'>LỖI DATABASE: " . mysqli_error($conn) . "</p>";
            } else {
                echo "<p style='padding: 20px; color: red;'>Danh mục này hiện chưa có món Gà Giòn nào trong Database.</p>";
            }
        }
        ?>
...
<script>
            ...
            'url': "https://jollibee.com.vn/ga-gion-vui-ve.html",
            'img_url': "/media/catalog/category/Ga_Gio_n_Vui_Ve_.jpg"
        });
    </script>
