<?php
session_start();
include 'includes/connect.php'; // Đảm bảo đường dẫn này đúng

$message = ""; // Biến để hiện thông báo lỗi lên form

if (isset($_POST['btn_register'])) {
    $username = mysqli_real_escape_string($conn, $_POST['username']);
    $password = mysqli_real_escape_string($conn, $_POST['password']);
    $re_password = mysqli_real_escape_string($conn, $_POST['password_confirmation']);
    $lastname = mysqli_real_escape_string($conn, $_POST['lastname']);
    $firstname = mysqli_real_escape_string($conn, $_POST['firstname']);
    $phone = mysqli_real_escape_string($conn, $_POST['phone']);
    $fullname = $lastname . " " . $firstname;

if (empty($username) || empty($password) || empty($lastname) || empty($firstname) || empty($phone)) {
        $message = "<p style='color:red; font-weight:bold;'>Vui lòng điền đầy đủ tất cả thông tin!</p>";
    } 
    elseif ($password !== $re_password) {
        $message = "<p style='color:red; font-weight:bold;'>Mật khẩu xác nhận không khớp!</p>";
    } else {
        $check = $conn->query("SELECT * FROM TaiKhoan WHERE TenDangNhap = '$username'");
        if ($check->num_rows > 0) {
            $message = "<p style='color:red; font-weight:bold;'>Tên đăng nhập đã tồn tại!</p>";
        } else {
            $conn->begin_transaction();
            try {
                // Ghi vào TaiKhoan (Quyền cố định là Khach)
                $conn->query("INSERT INTO TaiKhoan (TenDangNhap, MatKhau, Quyen) VALUES ('$username', md5('$password'), 'Khach')");
                // Ghi vào KhachHang
                $conn->query("INSERT INTO KhachHang (TenDangNhap, TenKH, SDT) VALUES ('$username', '$fullname', '$phone')");
                
                $conn->commit();
                header("Location: login.php?msg=success"); // Đăng ký xong đẩy sang login
                exit();
            } catch (Exception $e) {
                $conn->rollback();
                $message = "<p style='color:red;'>Lỗi hệ thống, vui lòng thử lại!</p>";
            }
        }
    }
}
    ...
    <span>
        ...
        <div class="actions options switcher-options">
            ...
            <div class="switcher-list">
                            ...
                            <a href="https://jollibee.com.vn/stores/store/redirect/___store/en/___from_store/default/uenc/aHR0cHM6Ly9qb2xsaWJlZS5jb20udm4vY3VzdG9tZXIvYWNjb3VudC9jcmVhdGUvP19fX3N0b3JlPWVu/">
                                EN                            </a>
                        </div>
                                                                                    </div>
        </div>
    </div>
<ul class="header links">    <li class="customer-icon">
        <a href="#social-login-popup" class="social-login-btn" data-effect="mfp-move-from-top"><span class="icon"></span></a>
    </li>
<li><a href="https://jollibee.com.vn/customer/account/create/" id="idVZjZjxm2">Đăng ký</a></li><li class="authorization-link" data-label="or">
    <a href="login.php" class="social-login-btn" data-effect="mfp-move-from-top">
        Đăng nhập    </a>
</li>
...
<ul id="menu" class="nav-menu ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" tabindex="0">
<li class="level0 level-top ui-menu-item home"><a href="/">Trang Chủ</a></li>
<li class="level0 level-top ui-menu-item about"><a href="/ve-jollibee">Về Jollibee</a></li>
<li class="level0 level-top parent ui-menu-item" data-item-nav="item-menu" role="presentation"><a href="/mon-moi-mon-ngon.html" aria-haspopup="true" id="ui-id-2" class="ui-corner-all" tabindex="-1" role="menuitem"><span class="ui-menu-icon ui-icon ui-icon-carat-1-e"></span>Thực đơn</a> 
<ul class="menu-list ui-menu ui-widget ui-widget-content ui-corner-all" role="menu" aria-hidden="true" aria-expanded="false" style="display: none;">
    <li class="level0 nav-1 category-item first level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/mon-moi-mon-ngon.html" class="level-top ui-corner-all" id="ui-id-3" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/web-12_1_1.png" class="thumbnail" width="100px"><span>Món Ngon Phải Thử</span></a></li><li class="level0 nav-2 category-item level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/ga-gion-vui-ve.html" class="level-top ui-corner-all" id="ui-id-4" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/web-05_1.png" class="thumbnail" width="100px"><span>Gà Giòn Vui Vẻ</span></a></li><li class="level0 nav-3 category-item level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/mi-y-sot-bo-bam.html" class="level-top ui-corner-all" id="ui-id-5" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/web-06.png" class="thumbnail" width="100px"><span>Mì Ý Jolly</span></a></li><li class="level0 nav-4 category-item level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/ga-sot-cay.html" class="level-top ui-corner-all" id="ui-id-6" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/web-07.png" class="thumbnail" width="100px"><span>Gà Sốt Cay</span></a></li><li class="level0 nav-5 category-item level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/burger-com.html" class="level-top ui-corner-all" id="ui-id-7" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/cat_burger_1.png" class="thumbnail" width="100px"><span>Burger/Cơm</span></a></li><li class="level0 nav-6 category-item level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/phan-an-phu.html" class="level-top ui-corner-all" id="ui-id-8" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/phananphu.png" class="thumbnail" width="100px"><span>Phần Ăn Phụ</span></a></li><li class="level0 nav-7 category-item level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/mon-trang-mieng.html" class="level-top ui-corner-all" id="ui-id-9" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/trangmieng.png" class="thumbnail" width="100px"><span>Món Tráng Miệng</span></a></li><li class="level0 nav-8 category-item last level-top ui-menu-item" role="presentation"><a href="https://jollibee.com.vn/thuc-uong.html" class="level-top ui-corner-all" id="ui-id-10" tabindex="-1" role="menuitem"><img src="https://jollibee.com.vn//media/catalog/category/thucuong.png" class="thumbnail" width="100px"><span>Thức Uống</span></a></li>    </ul>
<script type="text/javascript">
    // <![CDATA[
    require([
        'jquery',
...
<li class="level0 level-top ui-menu-item service"><a href="/dich-vu" class="">Dịch Vụ</a></li>
<li class="level0 level-top ui-menu-item news"><a href="/tin-tuc" class="">Tin Tức</a></li>
<li class="level0 level-top ui-menu-item store"><a href="/cua-hang" class="">Cửa hàng</a></li>
...
<li class="level0 level-top ui-menu-item career"><a href="https://jollibee.talent.vn/">Tuyển dụng</a></li>
    ...
    <a href="login.php" data-effect="mfp-move-from-top">
        Đăng nhập    </a>
</li>
<li><a href="https://jollibee.com.vn/customer/account/create/" id="idma66GOqV">Đăng ký</a></li></ul><div class="download-app">
...
<script src="https://jollibee.com.vn/media/location/province_20260408110937.js"></script>
<script src="https://jollibee.com.vn/media/location/district_20260408110937.js"></script>
...
<main id="maincontent" class="page-main"><a id="contentarea" tabindex="-1"></a>
    <div class="page-title-wrapper">
                <h1 class="page-title">
    <span class="base">Đăng ký tài khoản</span>
</h1>
...
<div data-bind="scope: 'messages'">
...
</div><div class="columns"><div class="column main">    <div id="full-address-popup">
    ...
    <script>
        require.config({
            map: {
                "*": {
                    "googleMapPlaceLibrary": "https://maps.googleapis.com/maps/api/js?key=REMOVED_GOOGLE_API_KEY&v=3.exp&libraries=places&language=vi_VN"
                }
            }
        });
    </script>
    
<input name="form_key" type="hidden" value="ImwYKAOSVVPg94iw"><div id="authenticationPopup" data-bind="scope:'authenticationPopup', style: {display: 'none'}" style="display: none;">
...
<!-- /ko -->
    ...
    <div class="block col-mp mp-12">
        <div class="block-content">
            <form class="form-fake-email" id="social-form-fake-email" data-gtm-form-interact-id="2">
...
<script>
    require(['jquery'], function($) {
        ...
        <div class="block-content" aria-labelledby="block-customer-login-heading">
            <form class="form-customer-login" id="social-form-login" data-gtm-form-interact-id="3">
                <input name="form_key" type="hidden" value="ImwYKAOSVVPg94iw">                <div class="form-outler form-outler-top">
                    <fieldset class="fieldset login mp-8" data-hasrequired="* Phần bắt buộc">
                        ...
                        <div class="field password required">
                            <div class="control">
                                <input name="password" id="social_login_pass" type="password" class="input-text valid" autocomplete="off" title="Mật khẩu" data-validate="{required:true, 'validate-password':true}" placeholder="Mật khẩu" aria-required="true" data-gtm-form-interact-field-id="7">
                            </div>
                        </div>
    ...
    <div class="block col-mp mp-12">
        <div class="block-content">
                                    <form class="form-customer-create" id="social-form-create"  data-gtm-form-interact-id="0">
    ...
    <div class="control">
        <select id="gender" name="gender" title="Giới tính" class="validate-select" data-validate="{required:true}" aria-required="true">
                    ...
                    <div class="field password required">
                        ...
                        <div class="control">
                            <input type="password" name="password" id="password-social" title="Mật khẩu" class="input-text valid" data-validate="{required:true, 'validate-password':true}" autocomplete="off" aria-required="true" data-gtm-form-interact-field-id="1">
                        </div>
                    </div>
...
<form class="form create account form-create-account js-form-create-account" action="" method="post" id="form-validate" enctype="multipart/form-data" autocomplete="off" >
    <input name="form_key" type="hidden" value="ImwYKAOSVVPg94iw">    <fieldset class="fieldset create info">
    <div class="field required">
    <div class="control">
        <input type="text" name="username" placeholder="Tên đăng nhập (viết liền không dấu) *" class="input-text" required style="margin-bottom: 15px;">
    </div>
</div>
        <input type="hidden" name="success_url" value="">
        <input type="hidden" name="error_url" value="">
                                ...
                                <div class="field field-name-lastname required">
                    <div class="control">
                        <input type="text" id="lastname" name="lastname" value="" title="Họ" class="input-text required-entry" data-validate="{required:true}" placeholder="Họ *" autocomplete="off" aria-required="true">
                    </div>
                </div>
                                <div class="field field-name-firstname required">
                    <div class="control">
                        <input type="text" id="firstname" name="firstname" value="" title="Tên" class="input-text required-entry" data-validate="{required:true}" placeholder="Tên *" autocomplete="off" aria-required="true">
                    </div>
                </div>
                    ...
                    <div class="field required">
                <div class="control">
                    <input placeholder="Số điện thoại *" type="text" name="phone" id="phone_number" value="" title="Số điện thoại" class="input-text" data-validate="{required:true, 'validate-number':true, 'validate-phoneLax': true}" autocomplete="off" aria-required="true">
                </div>
            </div>
        
        <div class="field required">
            <div class="control">
                <input placeholder="E-mail" type="email" name="email" autocomplete="email" id="email_address" value="" title="E-mail" class="input-text" data-validate="{'validate-email':true}" aria-required="true">
            </div>
        </div>
        <div class="field password required">
            <div class="control">
                <input type="password" name="password" id="password" title="Mật khẩu" class="input-text" data-password-min-length="8" data-password-min-character-sets="3" data-validate="{required:true, 'validate-customer-password':true}" autocomplete="off" placeholder="Mật khẩu *" aria-required="true">
        ...
        <div class="field confirmation required">
            <div class="control">
                <input placeholder="Xác nhận mật khẩu *" type="password" name="password_confirmation" title="Xác nhận mật khẩu" id="password-confirmation" class="input-text" data-validate="{required:true, equalTo:'#password'}" autocomplete="off" aria-required="true">
            </div>
        </div>

                            <div class="field date field-dob required">
    <div class="control customer-dob">
        <input type="date" name="dob" id="dob" value="" placeholder="Ngày sinh *" class="_has-datepicker" data-validate="{&quot;required&quot;:true,&quot;validate-date&quot;:{&quot;dateFormat&quot;:&quot;d\/M\/Y&quot;},&quot;validate-dob&quot;:{&quot;dateFormat&quot;:&quot;d\/M\/Y&quot;}}" autocomplete="on" aria-required="true"><button type="button" class="ui-datepicker-trigger v-middle"><span>Select Date</span></button> <script type="text/javascript">
            require(["jquery", "mage/calendar"], function($){
                    $("#dob").calendar({
                        showsTime: false,
    ...
    <div class="control">
        <select id="gender" name="gender" title="Giới tính" class="validate-select" data-validate="{required:true}" aria-required="true">
                            ...
                            <div class="field province_customer required">
    <div class="control">
        <select id="province_customer" name="province_customer" title="province_customer" aria-required="true">
        ...
        <div class="field agreement">
            <label for="agreement" class="label"><span>Đồng ý với </span><a href="/chinh-sach-va-quy-dinh-chung" target="_blank">Chính sách, quy định chung và Thông báo bảo mật cá nhân</a></label>
            <input data-validate="{required:true}" type="checkbox" name="agreement" title="Đồng ý với" value="1" id="agreement" class="checkbox">
        </div>

                    <div class="field choice newsletter">
                <input type="checkbox" name="is_subscribed" title="Nhận chương trình khuyến mãi qua email" value="1" id="is_subscribed" class="checkbox">
                <label for="is_subscribed" class="label"><span>Nhận chương trình khuyến mãi qua email</span></label>
            </div>
                                            </fieldset>
    <div class="actions-toolbar">
        <div class="primary">
            <button type="submit" name="btn_register" class="action submit primary js-registration-submit" title="Đăng ký"><span>Đăng ký</span></button>
        </div>
        <div class="trigger-login">
...
<script>
    require([
        ...
        dataForm.mage('validation', {
            messages: {
                'phone_number': {
                    'validate-phoneLax': 'Vui lòng nhập số điện thoại hợp lệ. Ví dụ: 0123456789'
                }
            },
            "rules": {
                "gender": {
        ...
        $('.trigger-login a').click(function (e) {
            e.preventDefault();
...
<div class="otp-popup jollibee-popup js-otp-popup" style="display: none">
    <button title="Close (Esc)" type="button" class="mfp-close js-otp-popup-close">×</button>
    <form action="#" class="otp-form js-otp-form" method="post" autocomplete="off" >
        <div class="popup--top">
            ...
            <div class="popup__content">
                <p class="verification-notice js-text-wrapper">Chúng tôi đã gửi mã xác thực đến số điện thoại                     <span class="phone-number js-otp-phone-number"></span>.<br>
                    Vui lòng nhập mã xác nhận để hoàn thành                     <span class="js-register-text">đăng ký.</span>
                    <span class="js-update-text">cập nhật.</span></p>
                <p class="error-message js-error-message"></p>
                <input type="text" name="otp_code" class="otp-input" placeholder="Nhập mã xác nhận" data-validate="{required:true, 'validate-number':true}">
            </div>
        </div>
        <div class="popup--bottom">
            <div class="popup__action">
                <button type="submit" class="action primary">Xác nhận</button>
                <p class="otp-countdown-text js-otp-countdown-text">Gửi lại mã sau <b class="otp-countdown js-otp-countdown"></b></p>
                <p><a href="#" class="resend-otp js-resend-otp">Gửi lại mã xác nhận</a></p>
            </div>
        </div>
    </form>
</div>
...
<div data-block="minicart" class="minicart-wrapper">
    <div data-trigger="minicart-content-trigger" class="minicart-content-trigger">
        <a class="action showcart" href="https://jollibee.com.vn/checkout/cart/" data-bind="scope: 'minicart_content'">
...
<div class="block-title">
    <strong>
        <span class="text" data-bind="i18n: 'Your cart'">Đơn hàng của bạn</span>
    </strong>
    <button type="button" id="btn-minicart-close" class="action close" data-action="close" data-bind="attr: { title: $t('Close') }" title="Đóng cửa">
        <span data-bind="i18n: 'Close'">Đóng cửa</span>
    </button>
</div>
...
<script>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"NRJS-495c32bbd15c5696a46","applicationID":"1396432117","transactionName":"MQQDNUEECBEAAEQIWwhOIAJHDAkMThNRBlE5AgACWwA=","queueTime":0,"applicationTime":61,"atts":"HUMAQwkeGx8=","errorBeacon":"bam.nr-data.net","agent":""}</script><script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon="{&quot;version&quot;:&quot;2024.11.0&quot;,&quot;token&quot;:&quot;e1824f48925549988f18394ee6dbcc2d&quot;,&quot;server_timing&quot;:{&quot;name&quot;:{&quot;cfCacheStatus&quot;:true,&quot;cfEdge&quot;:true,&quot;cfExtPri&quot;:true,&quot;cfL4&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfSpeedBrain&quot;:true},&quot;location_startswith&quot;:null}}" crossorigin="anonymous"></script>


<div id="ui-datepicker-div" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-header ui-widget-header ui-helper-clearfix ui-corner-all"><a class="ui-datepicker-prev ui-corner-all" data-handler="prev" data-event="click" title="Prev"><span class="ui-icon ui-icon-circle-triangle-w">Prev</span></a><a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="Next"><span class="ui-icon ui-icon-circle-triangle-e">Next</span></a><div class="ui-datepicker-title"><select class="ui-datepicker-month" data-handler="selectMonth" data-event="change"><option value="0">Jan</option><option value="1">Feb</option><option value="2">Mar</option><option value="3" selected="selected">Apr</option></select><select class="ui-datepicker-year" data-handler="selectYear" data-event="change"><option value="1906">1906</option><option value="1907">1907</option><option value="1908">1908</option><option value="1909">1909</option><option value="1910">1910</option><option value="1911">1911</option><option value="1912">1912</option><option value="1913">1913</option><option value="1914">1914</option><option value="1915">1915</option><option value="1916">1916</option><option value="1917">1917</option><option value="1918">1918</option><option value="1919">1919</option><option value="1920">1920</option><option value="1921">1921</option><option value="1922">1922</option><option value="1923">1923</option><option value="1924">1924</option><option value="1925">1925</option><option value="1926">1926</option><option value="1927">1927</option><option value="1928">1928</option><option value="1929">1929</option><option value="1930">1930</option><option value="1931">1931</option><option value="1932">1932</option><option value="1933">1933</option><option value="1934">1934</option><option value="1935">1935</option><option value="1936">1936</option><option value="1937">1937</option><option value="1938">1938</option><option value="1939">1939</option><option value="1940">1940</option><option value="1941">1941</option><option value="1942">1942</option><option value="1943">1943</option><option value="1944">1944</option><option value="1945">1945</option><option value="1946">1946</option><option value="1947">1947</option><option value="1948">1948</option><option value="1949">1949</option><option value="1950">1950</option><option value="1951">1951</option><option value="1952">1952</option><option value="1953">1953</option><option value="1954">1954</option><option value="1955">1955</option><option value="1956">1956</option><option value="1957">1957</option><option value="1958">1958</option><option value="1959">1959</option><option value="1960">1960</option><option value="1961">1961</option><option value="1962">1962</option><option value="1963">1963</option><option value="1964">1964</option><option value="1965">1965</option><option value="1966">1966</option><option value="1967">1967</option><option value="1968">1968</option><option value="1969">1969</option><option value="1970">1970</option><option value="1971">1971</option><option value="1972">1972</option><option value="1973">1973</option><option value="1974">1974</option><option value="1975">1975</option><option value="1976">1976</option><option value="1977">1977</option><option value="1978">1978</option><option value="1979">1979</option><option value="1980">1980</option><option value="1981">1981</option><option value="1982">1982</option><option value="1983">1983</option><option value="1984">1984</option><option value="1985">1985</option><option value="1986">1986</option><option value="1987">1987</option><option value="1988">1988</option><option value="1989">1989</option><option value="1990">1990</option><option value="1991">1991</option><option value="1992">1992</option><option value="1993">1993</option><option value="1994">1994</option><option value="1995">1995</option><option value="1996">1996</option><option value="1997">1997</option><option value="1998">1998</option><option value="1999">1999</option><option value="2000">2000</option><option value="2001">2001</option><option value="2002">2002</option><option value="2003">2003</option><option value="2004">2004</option><option value="2005">2005</option><option value="2006">2006</option><option value="2007">2007</option><option value="2008">2008</option><option value="2009">2009</option><option value="2010">2010</option><option value="2011">2011</option><option value="2012">2012</option><option value="2013">2013</option><option value="2014">2014</option><option value="2015">2015</option><option value="2016">2016</option><option value="2017">2017</option><option value="2018">2018</option><option value="2019">2019</option><option value="2020">2020</option><option value="2021">2021</option><option value="2022">2022</option><option value="2023">2023</option><option value="2024">2024</option><option value="2025">2025</option><option value="2026" selected="selected">2026</option></select></div></div><table class="ui-datepicker-calendar"><thead><tr><th><span title="Monday">Mo</span></th><th><span title="Tuesday">Tu</span></th><th><span title="Wednesday">We</span></th><th><span title="Thursday">Th</span></th><th><span title="Friday">Fr</span></th><th class="ui-datepicker-week-end"><span title="Saturday">Sa</span></th><th class="ui-datepicker-week-end"><span title="Sunday">Su</span></th></tr></thead><tbody><tr><td class=" ui-datepicker-other-month ui-datepicker-unselectable ui-state-disabled">&nbsp;</td><td class=" ui-datepicker-other-month ui-datepicker-unselectable ui-state-disabled">&nbsp;</td><td class=" " data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default" href="#">1</a></td><td class=" " data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default" href="#">2</a></td><td class=" " data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default" href="#">3</a></td><td class=" ui-datepicker-week-end " data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default" href="#">4</a></td><td class=" ui-datepicker-week-end " data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default" href="#">5</a></td></tr><tr><td class=" " data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default" href="#">6</a></td><td class=" ui-datepicker-days-cell-over  ui-datepicker-current-day" data-handler="selectDay" data-event="click" data-month="3" data-year="2026"><a class="ui-state-default ui-state-active ui-state-hover" href="#">7</a></td><td class=" ui-datepicker-unselectable ui-state-disabled  ui-datepicker-today"><span class="ui-state-default">8</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">9</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">10</span></td><td class=" ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">11</span></td><td class=" ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">12</span></td></tr><tr><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">13</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">14</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">15</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">16</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">17</span></td><td class=" ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">18</span></td><td class=" ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">19</span></td></tr><tr><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">20</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">21</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">22</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">23</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">24</span></td><td class=" ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">25</span></td><td class=" ui-datepicker-week-end ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">26</span></td></tr><tr><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">27</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">28</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">29</span></td><td class=" ui-datepicker-unselectable ui-state-disabled "><span class="ui-state-default">30</span></td><td class=" ui-datepicker-other-month ui-datepicker-unselectable ui-state-disabled">&nbsp;</td><td class=" ui-datepicker-week-end ui-datepicker-other-month ui-datepicker-unselectable ui-state-disabled">&nbsp;</td><td class=" ui-datepicker-week-end ui-datepicker-other-month ui-datepicker-unselectable ui-state-disabled">&nbsp;</td></tr></tbody></table></div>
...
<script type="text/javascript" id="" charset="">!function(d,g,e){d.TiktokAnalyticsObject=e;var a=d[e]=d[e]||[];a.methods="page track identify instances debug on off once ready alias group enableCookie disableCookie".split(" ");a.setAndDefer=function(b,c){b[c]=function(){b.push([c].concat(Array.prototype.slice.call(arguments,0)))}};for(d=0;d<a.methods.length;d++)a.setAndDefer(a,a.methods[d]);a.instance=function(b){b=a._i[b]||[];for(var c=0;c<a.methods.length;c++)a.setAndDefer(b,a.methods[c]);return b};a.load=function(b,c){var f="https://analytics.tiktok.com/i18n/pixel/events.js";
a._i=a._i||{};a._i[b]=[];a._i[b]._u=f;a._t=a._t||{};a._t[b]=+new Date;a._o=a._o||{};a._o[b]=c||{};c=document.createElement("script");c.type="text/javascript";c.async=!0;c.src=f+"?sdkid\x3d"+b+"\x26lib\x3d"+e;b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(c,b)};a.load("CNLBDVBC77U4TBB0R76G");a.page()}(window,document,"ttq");</script><div class="modals-wrapper"><!--
/**
 * Plumrocket Inc.
 *
 * NOTICE OF LICENSE
...
<aside role="dialog" class="modal-custom pr-cookie-modal pr-cookie-modal-bottom
               " aria-describedby="modal-content-25" data-role="modal" data-type="custom" tabindex="0">
    <div data-role="focusable-start" tabindex="0"></div>
    <div class="modal-inner-wrap" data-role="focusable-scope" style="background-color: rgba(0, 34, 68, 0.89);">
        <div id="modal-content-25" class="modal-content" data-role="content"><div id="pr-cookie-notice" data-bind="afterRender: autoOpen()">
    <div class="pr-cookie-notice-wrap">
        <div class="pr-cookie-notice-text" data-bind="html: noticeTextHtml" style="color: rgb(230, 230, 230);"><p>Trang web này yêu cầu sử dụng cookie để cung cấp đầy đủ tất cả các tính năng. Để biết thêm thông tin về dữ liệu có trong cookie, vui lòng xem trang <a href="https://jollibee.com.vn/chinh-sach-cookie" target="_blank" rel="noopener">Chính sách Cookie</a> của chúng tôi. Để chấp nhận cookie từ trang web này, vui lòng nhấp vào nút Chấp nhận Cookie bên dưới.</p></div>
        <div class="actions pr-cookie-notice-actions">
            <button id="btn-cookie-allow" class="action allow primary pr-cookie-notice-btn" data-bind="style: {
                    color: acceptButtonConfig.text_color,
                    backgroundColor: acceptButtonConfig.background_color,
                    borderColor: acceptButtonConfig.background_color
                }, click: allowAll">
                <!-- ko i18n: acceptButtonConfig.label --><span>Chấp nhận Cookie</span><!-- /ko -->
            </button>
            <!-- ko if: declineButtonConfig.enabled --><button id="btn-cookie-decline" class="action decline pr-cookie-notice-btn" data-bind="style: {
                    color: declineButtonConfig.text_color,
                    backgroundColor: declineButtonConfig.background_color,
                    borderColor: declineButtonConfig.background_color
                }, click: declineAll">
                <!-- ko i18n: declineButtonConfig.label --><span>Từ chối</span><!-- /ko -->
            </button><!-- /ko -->
            <!-- ko if: settingsButtonConfig.enabled --><button class="action pr-cookie-notice-btn pr-cookie-setting-btn setting-link" data-bind="css: {
                ...
                <!-- ko i18n: settingsButtonConfig.label --><span>Tùy chỉnh cài đặt Cookie</span><!-- /ko -->
            </button><!-- /ko -->
        </div>
    </div>
...
<aside role="dialog" class="modal-popup pr-cookie-details-modal
               
               " aria-describedby="modal-content-29" data-role="modal" data-type="popup" tabindex="0">
<div data-role="focusable-start" tabindex="0"></div>
<div class="modal-inner-wrap" data-role="focusable-scope">
    <div id="modal-content-29" class="modal-content" data-role="content"><div id="pr-cookie-setting-bar" data-bind="afterRender: createModal()">
    <div class="pr-cookie-setting-bar-wrap">
        <button class="pr-cookie-close" type="button" aria-label="close popup" data-bind="click: closeModal"></button>
        <div class="pr-cookie-detail-view">
            <h3 class="pr-cookie-title" data-bind="text: overview.title">Quyền riêng tư và Cookies</h3>
            <div class="pr-cookie-description" data-bind="html: overview.text"><p data-start="0" data-end="340">Cookie là thông tin được lưu trữ trên máy tính của bạn bởi một trang web mà bạn truy cập. Cookie giúp trang web nhận diện bạn và ghi nhớ các tùy chọn của bạn. Các trang web thương mại điện tử sử dụng cookie trên trình duyệt của khách truy cập để lưu thông tin đăng nhập, xác định khách hàng và cung cấp trải nghiệm mua sắm được cá nhân hóa.</p>
<p data-start="342" data-end="851" data-is-last-node="" data-is-only-node="">Chúng tôi tôn trọng quyền riêng tư của từng cá nhân và nhận thức được tầm quan trọng của dữ liệu cá nhân mà khách hàng tin tưởng giao phó cho chúng tôi. Bất kỳ khách truy cập nào cũng có thể chọn không cho phép một số loại cookie. Nhấp vào tiêu đề danh mục cookie và chi tiết cookie để tìm hiểu thêm và thay đổi cài đặt mặc định của chúng tôi. Tuy nhiên, việc chặn một số loại cookie có thể ảnh hưởng đến trải nghiệm của bạn trên trang web và ngăn bạn sử dụng đầy đủ các tính năng trên cửa hàng của chúng tôi.</p></div>
            <div class="pr-actions-buttons">
                <button class="action allow primary" type="button" data-role="action" data-bind="style: {
                        color: acceptButtonConfig.text_color,
                        backgroundColor: acceptButtonConfig.background_color,
                        borderColor: acceptButtonConfig.background_color
                    }, text: acceptButtonConfig.label, click: allowAll">Chấp nhận tất cả</button>
                <!-- ko if: declineButtonConfig.enabled --><button class="action decline" type="button" data-role="action" data-bind="style: {
                        color: declineButtonConfig.text_color,
                        backgroundColor: declineButtonConfig.background_color,
                        borderColor: declineButtonConfig.background_color
                    }, text: declineButtonConfig.label, click: declineAll">Từ chối tất cả</button><!-- /ko -->
            </div>
            <h3 class="pr-cookie-manage-title" data-bind="text: consentPreferences.header">Quản lý tùy chọn chấp thuận</h3>
            <ul class="message-system-list">
                <!-- ko repeat: {foreach: categories, item: 'category'} --><li data-repeat-index="0">
                    <div data-bind="css: {'category-open': category().categoryVisible}" class="accordion-title">
                        <div class="pr-cookie-option" data-bind="click: toggleAccordion.bind(category())">
                            <strong class="option-label" data-bind="text: category().name">Strictly necessary cookies</strong>
                            <!-- ko if: category().is_essential -->
                                <strong class="option-status" data-bind="text: consentPreferences.essential_category_status">Luôn hoạt động</strong>
                            <!-- /ko -->
                            <!-- ko ifnot: category().is_essential --><!-- /ko -->
                        </div>
                        <div class="first-details" data-bind="attr:{'open': category().detailVisible}" open="true">
                            <div class="pr-cookie-category-descrip" data-bind="text: category().description">Những cookie này là cần thiết để bạn có thể duyệt cửa hàng của chúng tôi và sử dụng các tính năng của nó, chẳng hạn như truy cập vào các khu vực bảo mật của trang web. Ví dụ về cookie tuyệt đối cần thiết bao gồm cookie lưu giữ các sản phẩm trong giỏ hàng của bạn, cookie giúp bạn duy trì trạng thái đăng nhập và cookie lưu lại các tùy chọn cá nhân hóa của bạn. Đây là những cookie cần thiết cho hoạt động của trang web và không thể bị tắt bởi người dùng.</div>
                            <!-- ko if: canShowCookieDetails --><!-- /ko -->
                        </div>
                    </div>
                </li><li data-repeat-index="1">
                    <div data-bind="css: {'category-open': category().categoryVisible}" class="accordion-title">
                        <div class="pr-cookie-option" data-bind="click: toggleAccordion.bind(category())">
                            <strong class="option-label" data-bind="text: category().name">Preferences cookies</strong>
                            <!-- ko if: category().is_essential --><!-- /ko -->
                            <!-- ko ifnot: category().is_essential -->
                                <div class="pr-cookie-switch" data-role="switcher" data-bind="click: function(){return true}, clickBubble: false">
                    ...
                    <div data-bind="css: {'category-open': category().categoryVisible}" class="accordion-title">
                        <div class="pr-cookie-option" data-bind="click: toggleAccordion.bind(category())">
                            <strong class="option-label" data-bind="text: category().name">Statistics cookies</strong>
                            <!-- ko if: category().is_essential --><!-- /ko -->
                            <!-- ko ifnot: category().is_essential -->
                                <div class="pr-cookie-switch" data-role="switcher" data-bind="click: function(){return true}, clickBubble: false">
                                    <label class="switch-label" aria-label="Switch">
                    ...
                    <div data-bind="css: {'category-open': category().categoryVisible}" class="accordion-title">
                        <div class="pr-cookie-option" data-bind="click: toggleAccordion.bind(category())">
                            <strong class="option-label" data-bind="text: category().name">Marketing cookies</strong>
                            <!-- ko if: category().is_essential --><!-- /ko -->
                            <!-- ko ifnot: category().is_essential -->
                                <div class="pr-cookie-switch" data-role="switcher" data-bind="click: function(){return true}, clickBubble: false">
                                    <label class="switch-label" aria-label="Switch">
                        ...
                        <div class="first-details" data-bind="attr:{'open': category().detailVisible}" open="true">
                            <div class="pr-cookie-category-descrip" data-bind="text: category().description">Những cookie này theo dõi hoạt động trực tuyến của bạn để giúp nhà quảng cáo hiển thị các quảng cáo phù hợp hơn hoặc giới hạn số lần bạn nhìn thấy một quảng cáo. Các cookie này có thể chia sẻ thông tin đó với các tổ chức hoặc nhà quảng cáo khác. Đây là các cookie lưu trữ lâu dài và gần như luôn đến từ bên thứ ba.</div>
                            <!-- ko if: canShowCookieDetails --><!-- /ko -->
                        </div>
                    </div>
                </li><!-- /ko -->
        ...
        <button class="action confirm primary" data-bind="
                    style: {
                    ...
                    text: confirmButtonConfig.label, click: confirmChosen">Xác nhận lựa chọn của tôi</button>
    </div>
</div></div>
...
<aside role="dialog" class="modal-popup popup-authentication
    ...
    <div class="block block-new-customer" data-bind="attr: {'data-label': $t('or')}" data-label="or">
        ...
        <div class="block-content" aria-labelledby="block-new-customer-heading">
            ...
            <div class="actions-toolbar">
                <div class="primary">
                    <a class="action action-register primary" data-bind="attr: {href: registerUrl}" href="https://jollibee.com.vn/customer/account/create/">
...
<!-- ko if: isActive() --><!-- /ko --><!-- /ko -->
        <!-- /ko -->
        <div class="block-content" aria-labelledby="block-customer-login-heading">
            <form class="form form-login" method="post" data-bind="event: {submit: login }" id="login-form" data-gtm-form-interact-id="1">
                <div class="fieldset login" data-bind="attr: {'data-hasrequired': $t('* Required Fields')}" data-hasrequired="* Phần bắt buộc">
                    <div class="field email required">
                        <label class="label" for="customer-email"><span data-bind="i18n: 'Email Address'">Địa chỉ Email</span></label>
                        <div class="control">
                            <input name="username" id="customer-email" type="email" class="input-text" data-mage-init="{&quot;mage/trim-input&quot;:{}}" data-bind="attr: {autocomplete: autocomplete}" data-validate="{required:true, 'validate-email':true}" autocomplete="off" data-gtm-form-interact-field-id="2">
                        </div>
                    </div>
                    <div class="field password required">
                        <label for="pass" class="label"><span data-bind="i18n: 'Password'">Mật khẩu</span></label>
                        <div class="control">
                            <input name="password" type="password" class="input-text" id="pass" data-bind="attr: {autocomplete: autocomplete}" data-validate="{required:true}" autocomplete="off" data-gtm-form-interact-field-id="3">
                        </div>
                    </div>
                    ...
                    <div class="actions-toolbar">
                        ...
                        <div class="primary">
                            <button type="submit" class="action action-login secondary" name="send" id="send2">
                                <span data-bind="i18n: 'Sign In'">Đăng nhập</span>
                            </button>
                        </div>
                        <div class="secondary">
                            <a class="action" data-bind="attr: {href: forgotPasswordUrl}" href="https://jollibee.com.vn/customer/account/forgotpassword/">
                                <span data-bind="i18n: 'Forgot Your Password?'">Quên mật khẩu?</span>
                            </a>
                        </div>
                    </div>
                </div>
