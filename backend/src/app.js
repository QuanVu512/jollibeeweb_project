...
app.get('/health', (_req, res) => {
  res.json({ success: true, service: 'jollibee-admin-api', timestamp: new Date().toISOString() });
});
app.use('/api/v1', apiRoutes);
app.get('/assets/logo.png', (_req, res) => res.sendFile(logoFile));
app.use('/admin', express.static(adminDirectory, { index: 'index.html', extensions: ['html'] }));
