...
<div class="container">
    <h2 style="text-align: center; color: #d8262f; font-weight: 900; text-transform: uppercase;">ĐỔI MẬT KHẨU</h2>
    <div class="order-card">
        <form action="xuly_taikhoan.php" method="POST">
            <div style="margin-bottom: 15px;">
                <input type="password" name="old_pass" placeholder="Mật khẩu hiện tại" required style="width:100%; padding:12px; border:1px solid #ddd; border-radius:8px;">
            </div>
            <div style="margin-bottom: 15px;">
                <input type="password" name="new_pass" placeholder="Mật khẩu mới" required style="width:100%; padding:12px; border:1px solid #ddd; border-radius:8px;">
            </div>
            <div style="margin-bottom: 15px;">
                <input type="password" name="confirm_pass" placeholder="Xác nhận mật khẩu mới" required style="width:100%; padding:12px; border:1px solid #ddd; border-radius:8px;">
            </div>
            <button type="submit" name="btn_change_pass" class="btn btn-red">XÁC NHẬN ĐỔI</button>
        </form>
    </div>
</div>
<script>
